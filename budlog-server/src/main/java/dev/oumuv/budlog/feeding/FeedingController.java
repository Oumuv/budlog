...
public class FeedingController {
    ...
    @GetMapping
    public ApiResponse<PageResponse<FeedingResponse>> list(
    ...
    public ApiResponse<FeedingResponse> create(@Valid @RequestBody FeedingRequest request) {
        return ApiResponse.success(service.create(request));
    }

    @PutMapping("/{id}")
    public ApiResponse<FeedingResponse> update(@PathVariable Long id, @Valid @RequestBody FeedingRequest request) {
